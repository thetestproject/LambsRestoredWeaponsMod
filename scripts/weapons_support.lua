...
function Support_Laser:GetTargetArea(point)
	local ret = PointList()
...
function Support_Laser:GetSkillEffect(p1, p2)
	local targets = Support_Laser:GetTargetArea(point)
...
Support_Missiles_A = Support_Laser:new{
	Damage = 2,
}
